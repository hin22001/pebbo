...
import { WeeklyReport } from "@/src/app/api/lib/types/reportTypes";
...
export async function GET(req: Request) {
  type StudentWeeklyReportResponse = {
    student_id: string;
    student_name: string;
  ...
  try {
    ...
    // Get student's completed questions for the specified week
    ...
    const response: StudentWeeklyReportResponse = {
    ...
    return ResponseWrapper.success(response, "Student weekly report retrieved successfully");
  } catch (error) {
